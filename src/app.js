...
app.use(express.json({limit: "100kb"}))   //kitna json aa skta h uska limit lgane k liye
app.use(express.urlencoded({extended: true, limit: "100kb"}))    //url ayega usko encode krne k liye
